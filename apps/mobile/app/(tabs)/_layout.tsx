...
export default function TabLayout() {
  ...
  // Start at 0 so the Hub is initially visible (launch page)
  ...
  const tabsStyle = useAnimatedStyle(() => {
    // When translateX is -SCREEN_WIDTH, Tabs is centered (0 shift).
    const tx = translateX.value + SCREEN_WIDTH;
    return {
  ...
  const hubStyle = useAnimatedStyle(() => {
    // Animate opacity, scale, and subtle parallax for Hub
  ...
  const profileStyle = useAnimatedStyle(() => {
    // Animate opacity, scale, and subtle parallax for Profile
          ...
          <Animated.View style={[styles.page, {
            ...
            >
              <Tabs.Screen
                ...
                options={{
                  title: 'Physical',
                  href: enabledPillars.includes('physical') ? '/(tabs)/physical' : null,
                  tabBarActiveTintColor: '#ff0055',
              ...
              <Tabs.Screen
                ...
                options={{
                  title: 'Mental',
                  href: enabledPillars.includes('mental') ? '/(tabs)/mental' : null,
              ...
              <Tabs.Screen
                ...
                options={{
                  title: 'Wealth',
                  href: enabledPillars.includes('wealth') ? '/(tabs)/wealth' : null,
              ...
              <Tabs.Screen
                ...
                options={{
                  title: 'Vitality',
                  href: enabledPillars.includes('vitality') ? '/(tabs)/vitality' : null,
...
const styles = StyleSheet.create({
  ...
  gridOverlay: {
    ...
    backgroundColor: '#000',
    opacity: 0.8,
    // Emulate a futuristic grid using repeating linear gradients (handled natively as best effort on React Native using a tiled image or borders, but for pure Views we can use a border trick)
    borderWidth: 1,
