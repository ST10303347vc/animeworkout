...
/**
 * Platform-agnostic achievement definition.
 * Icon rendering is handled by each platform (web/mobile).
 */
export interface AchievementDef {
    id: string;
    title: string;
    description: string;
    /** Icon identifier — mapped to platform-specific icons per app */
    iconName: 'target' | 'flame' | 'zap' | 'star' | 'trophy' | 'scale';
    color: string;
